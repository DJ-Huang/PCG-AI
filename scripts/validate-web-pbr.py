#!/usr/bin/env python3
"""Bundle and execute the Web editor Standard PBR material contract."""
...
ENTRY = EDITOR / "scripts" / "pbr-materials-check.ts"
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="pcg-web-pbr-") as tmp:
        bundle = Path(tmp) / "pbr-materials-check.mjs"
