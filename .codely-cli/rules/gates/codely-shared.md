...
纯 Q&A、文档、Git、同步等 → `Read` `.codely-cli/rules/workflow/` 或对应 Skill，无需完整路由。
...
- **非开发任务** → 直接 `Read` `.codely-cli/rules/workflow/` 等
...
| 开发路由 | `rule-router` Skill 或 `.codely-cli/rules/gates/rule-router-gate.md` |

| Skills | `~/.codely-cli/extensions/MySkills/skills/<name>/SKILL.md` |
